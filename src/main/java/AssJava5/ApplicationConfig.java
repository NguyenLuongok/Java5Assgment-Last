...
import AssJava5.Repository.*;
import AssJava5.Service.*;
...
@EnableJpaRepositories("AssJava5.Repository")
@ComponentScan("AssJava5")
...
public class ApplicationConfig implements WebMvcConfigurer {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        emBean.setPackagesToScan(new String[]{"AssJava5.Model"});
